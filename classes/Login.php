            ...
            if (!$this->db_connection->connect_errno) {
                ...
                if ($checklogin->num_rows == 1) {
                    ...
                    if (password_verify($_POST['user_password'], $result_row->user_password_hash)) {
						...
						$sql='UPDATE users SET last_logon = '.$timestamp.' WHERE user_id = '.$user_id.'';
                        ...
                        $this->errors[] = 'Bad username or password. Try Again.';
                    }
                } else {
                    $this->errors[] = 'Bad username or password. Try Again.';
                }
            } else {
                $this->errors[] = 'DB Connection Issue. Try Again.';
            }
        } elseif (empty($_POST['user_name'])) {
            $this->errors[] = 'Username field empty. Try Again.';
        } elseif (empty($_POST['user_password'])) {
            $this->errors[] = 'Password field empty. Try Again.';
        }
    }
